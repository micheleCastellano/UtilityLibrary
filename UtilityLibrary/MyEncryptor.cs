...
namespace UtilityLibrary
{
    public static class MyEncryptor
    {
        ...
        public static (string encryptedPass, string salt) EncryptStringSalt(string sValue)
        {
        ...
        public static bool CheckLoginHashWithSalt(string pwd, string encryptedPwd, string salt)
        {
